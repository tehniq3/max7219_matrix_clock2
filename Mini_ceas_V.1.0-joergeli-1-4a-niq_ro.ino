...
#define ledalarma 8
#define senzor A2
byte senzorlumina = 0;  // 0 - no, 1 - yes
int brightness = 0;
byte nivel = 1;
...
if (senzorlumina == 1)
    brightness = map(analogRead(LIGHT), 0, 1023, 0, 15);
else
    brightness = nivel;
...
void basic(){
  ...
  while (run_mode()) {
    ...
    if (secs != rtc[0]) {     
      ...
      plot (16 - offset, 6, 1); //bottom pointj,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,
      }
      else {
   ...
   if(secs % 2 == 0){
      ...
      plot (15 - offset, 4, 0); //bottom point
      }
  ...
  if(circle){
     ...
     */
     if(secs % 2 == 0){
      ...
      plot (15, 4, 1); //bottom point
      plot (14, 3, 0); //left point
      plot (16, 3, 0); //left point
      }
      else {
      plot (15, 2, 0); //top point
      plot (15, 4, 0); //bottom point
      plot (14, 3, 1); //left point
      plot (16, 3, 1); //left point
      }
      old_secs = rtc[0];
